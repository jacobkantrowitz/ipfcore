---
title: "BU_All_Analysis_BCellCD79a_Disease_Interaction"
author: "Jake Kantrowitz"
date: "02/27/2017"
output: html_document
---

This analysis will focus on the B cell CD79a effect
...
plot(dds$Bcell.CD79a. ~ dds$TISSUE_DIAGNOSIS, col=c("grey90", "grey20"),
...
varOfInt <- "Bcell.CD79a."

dds2 <- dds
m2 <- model.matrix(~TISSUE_DIAGNOSIS + TISSUE_DIAGNOSIS:NESTED_PATIENT + Neutrophil + CD4 + CD8 + Eosinophils + Macrophage.CD68., colData(dds2))
m2 <- m2[ ,-which(apply(unname(m2), 2, sum)==0)]

m3 <- model.matrix(~TISSUE_DIAGNOSIS + TISSUE_DIAGNOSIS:NESTED_PATIENT + Neutrophil + CD4 + CD8 + Eosinophils + Macrophage.CD68. + Bcell.CD79a., colData(dds2))
m3 <- m3[ ,-which(apply(unname(m3), 2, sum)==0)]


deseqAnalysis(dds2, mod.full=m3, mod.reduced=m2, varOfInt = varOfInt, fdr = 0.25,
              filename = "BU_All_FullModel_BCellCD79a",
